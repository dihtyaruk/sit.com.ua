...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'extension/theme/oct_feelmart')) {
				$oct_feelmart[] = array(
					'name'	   => $this->language->get('text_oct_feelmart'),
			...
			if ($this->user->hasPermission('access', 'octemplates/module/oct_megamenu')) {
				$modules[] = [
					'name'	   => $this->language->get('text_oct_megamenu'),
					'href'     => $this->url->link('octemplates/module/oct_megamenu', 'user_token=' . $this->session->data['user_token'], true),
					'children' => []
				];
			}
