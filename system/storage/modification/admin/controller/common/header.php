...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		if (!isset($this->request->get['user_token']) || !isset($this->session->data['user_token']) || ($this->request->get['user_token'] != $this->session->data['user_token'])) {
			...
			if ($this->config->get('theme_oct_feelmart_alert_status')) {
				$data['oct_alert_status'] = $this->config->get('theme_oct_feelmart_alert_status');

				$data['oct_alert_data'] = $oct_alert_data = $this->config->get('theme_oct_feelmart_alert_data');
