...
class ControllerCatalogCategory extends Controller {
	...
	protected function validateForm() {
		...
		foreach ($this->request->post['category_description'] as $language_id => $value) {
			...
			$oct_feelmart_seo_title_data = $this->config->get('theme_oct_feelmart_seo_title_data');

			if (((utf8_strlen($value['meta_title']) < 1) || (utf8_strlen($value['meta_title']) > 255)) && !isset($oct_feelmart_seo_title_data['category']['title_empty'])) {
