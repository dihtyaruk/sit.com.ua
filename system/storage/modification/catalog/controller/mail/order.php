...
class ControllerMailOrder extends Controller {
	...
	public function add($order_info, $order_status_id, $comment, $notify) {
		...
		$data['products'] = array();
			...
			$oct_feelmart_contact_address = $oct_feelmart_data['contact_address'];
			...
			$data['oct_feelmart_contact_address'] = (isset($oct_feelmart_contact_address[$lang_id]) && !empty($oct_feelmart_contact_address[$lang_id])) ? html_entity_decode($oct_feelmart_contact_address[$lang_id], ENT_QUOTES, 'UTF-8') : false;

			$data['oct_feelmart_contact_telephone'] = (isset($oct_feelmart_data['contact_telephone']) && !empty($oct_feelmart_data['contact_telephone'])) ? array_values(array_filter(explode(PHP_EOL, $oct_feelmart_data['contact_telephone']))) : false;

			$data['oct_feelmart_contact_open'] = (isset($oct_feelmart_data['contact_open'][$lang_id]) && !empty($oct_feelmart_data['contact_open'][$lang_id])) ? array_values(array_filter(explode(PHP_EOL, $oct_feelmart_data['contact_open'][$lang_id]))) : false;
			
			$data['oct_feelmart_socials'] = (isset($oct_feelmart_data['socials']) && !empty($oct_feelmart_data['socials'])) ? $oct_feelmart_data['socials'] : false;
