...
class ControllerInformationContact extends Controller {
	...
	public function index() {
			...
			if ((isset($oct_feelmart_data['contact_view_map']) && $oct_feelmart_data['contact_view_map'] == 'on') && (isset($oct_feelmart_data['contact_map']) && !empty($oct_feelmart_data['contact_map']))) {
				$data['contact_map'] = html_entity_decode($oct_feelmart_data['contact_map'], ENT_QUOTES, 'UTF-8');
			}

			if (isset($oct_feelmart_data['contact_view_html'][(int)$this->config->get('config_language_id')]) && !empty(strip_tags($oct_feelmart_data['contact_view_html'][(int)$this->config->get('config_language_id')]))) {
				$data['contact_html'] = html_entity_decode($oct_feelmart_data['contact_view_html'][(int)$this->config->get('config_language_id')], ENT_QUOTES, 'UTF-8');
			}
